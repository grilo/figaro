...
function debugAPI() {
    ...
    return {
        ...
        create_inbox_note: mock({ success: true, path: 'Inbox/Quick-note.md', mtime: 1 }),
        ...
        line_numbers_load: mock({ enabled: false }),
        line_numbers_save: mock({ success: true }),
        ...
        file_has_uncommitted_changes: mock(false),
        auto_save_load: mock(300),
        auto_save_save: mock({ success: true }),
        auto_commit_load: mock(3600),
        auto_commit_save: mock({ success: true }),
        commit_current_file: mock(null),
