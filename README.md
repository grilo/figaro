...
**Outline** appears quietly in the status bar only when the active Markdown note has headings. It opens a nested heading navigator in the same right pane used by History and PDF Preview, highlights the section at the cursor or reading position, and moves the editor directly to a selected heading. Switching notes or opening History/PDF Preview closes it cleanly.
