...
- Mermaid widgets use the same full-width, bottom-center vertical resize affordance
  as managed Vega-Lite charts. They start at 300px, clamp between 180px and
  900px, show only the live height while dragging, and write one portable
...
- `.cm-mermaid-diagram-resize-handle` — the same approved bottom-center,
