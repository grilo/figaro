...
| `spellcheckCompartment` | Compartment + `@codemirror/lint` | Offline Hunspell marks for bundled US English, UK English, and Spanish dictionaries, with global/default and frontmatter selection |
